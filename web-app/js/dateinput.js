/*! DateInput v1.4.1 | haovei@qq.com */
$(function () {
    function a(c, d) {
    ...
    return a.DEFAULT_OPTS = {
        ...
        a.prototype = {
            build: function () {
                ...
                this.timeSelector = b("input", f),
                    ...
                    b.browser.msie && b.browser.version < 7 && (this.ieframe = b('<iframe class="date_selector_ieframe" frameborder="0" src="#"></iframe>').insertBefore(this.dateSelector), this.rootLayers = this.rootLayers.add(this.ieframe), b(".button", d).mouseover(function () {
            ...
            hide: function () {
                this.rootLayers.css("display", "none"),
                    b([window, document.body]).unbind("click", this.hideIfClickOutside),
                    this.input.focus(this.show),
                    b(document.body).unbind("keydown", this.keydownHandler)
            },
            ...
            stringToDate: function (a, b) {
                var c,
                    ...
                    f = this,
                    g = a,
                    h = [/yyyy|yy/, /M{1,2}/, /d{1,2}/, /H{1,2}/, /m{1,2}/, /s{1,2}/],
                    i = h.length,
                    j = [];
                if (g) {
                    for (var k = 0; i > k; k++) c = h[k].exec(f.format),
                        c && (d = c.index, j[k] = g.substring(d, d + c[0].length), b && (b = b.replace(h[k], j[k])));
            ...
            adjustDays: function (a) {
                for (var b = [], c = 0; c < a.length; c++) b[c] = a[(c + this.start_of_week) % 7];
                return b
            },
            setDateRange: function (a) {
                this.dateRange = b.extend({},
                    this.dateRange, a),
        ...
        b.fn.dateinput = function (c) {
            return this.each(function () {
                var d = b(this);
                d.data("dateinput-type") || (d.data("dateinput", new a(d, c)), d.data("dateinput-type", !0))
            })
        },
        b("input.date-input").live("mouseenter",
            function () {
                b(this).dateinput()
            }),
        b
